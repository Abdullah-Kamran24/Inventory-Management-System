/* PF Project "INVENTORY CONTROL SYSTEM"
  ...
  M. Haseeb Afridi (23P-0541)
  Ruman-ud-din (23P-0571)

 BS(CS) Section - 2C
 FAST-NUCES
*/
#include <stdio.h>
#include <string.h> //including the string library to use functions like strcmp & strcpy to compare and copy strings
...
void login(){ //function to handle login process
 ...
 scanf("%s", &pass);
 if(strcmp(user, "23P-0541") == 0 && strcmp(pass, "2004")==0){ //using strcmp to compare inputs
...
void getUserInput(int *choice) { //taking user input using pointers
 printf("\nChoice => ");
 scanf("%d", choice);
}
void listItems(){
 ...
 printf("Items not found, Please add items.\n");
 }
